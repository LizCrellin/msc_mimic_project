...
--
-- Original file:
-- mimic-iv/buildmimic/concepts_postgres/treatment/rrt.sql
--
-- Accessed: 24 July 2026
--
-- Modifications:
-- - Creation of views rather than tables
-- - No longer classifying as dialysis type - limiting to presence of dialysis and whether it is active
--
-- TO DO:
--
-- NOTES:
-- - May not include rrt initially as it's not of great importance for the study, and it's a complex definition
-- 
-- -----------------------------------------------------------------------------
...
WITH ce AS (
  SELECT
    ...
    CASE
      ...
      THEN 1
      WHEN ce.itemid IN (
        226499, /* | Hemodialysis Output */ /* | Dialysate Rate */
        224154, /* | Dwell Time (Peritoneal Dialysis) */
        225810, /* | Medication Added Amount  #1 (Peritoneal Dialysis) */
        225959, /* | Medication Added Amount  #2 (Peritoneal Dialysis) */
        227639,
        225183, /* | Current Goal */
      ...
      WHEN ce.itemid IN (
        ...
        224146, /* | System Integrity */ /* | Dialysis Catheter Site Appear */
        225323, /* | Dialysis Catheter Discontinued */
        225740, /* | Dialysis Catheter Dressing Type */
        225776, /* | Peritoneal Dialysis Fluid Appearance */
        225951, /* | Medication Added #1 (Peritoneal Dialysis) */
        225952,
        225953, /* | Solution (Peritoneal Dialysis) */
        225954, /* | Dialysis Access Type */
        225956, /* | Reason for CRRT Filter Change */
        225958, /* | Heparin Concentration (units/mL) */ /* | Medication Added Units #1 (Peritoneal Dialysis) */
        225961,
        225963, /* | Peritoneal Dialysis Catheter Type */
        225965, /* | Peritoneal Dialysis Catheter Status */
        225976, /* | Replacement Fluid */
        225977, /* | Dialysate Fluid */ /* | Dialysis Catheter Type | Access Lines - Invasive */
        227124,
        227290, /* | CRRT mode */ /* | Medication Added #2 (Peritoneal Dialysis) */
        227638, /* | Medication Added Units #2 (Peritoneal Dialysis) */
        227640, /* | Dialysis Catheter Placement Confirmed by X-ray */
        227753
      )
      THEN 1
      ELSE 0
  ...
  WHERE
    ce.itemid IN (      -- CHECK THIS LIST
      226118, /* === MetaVision itemids === -- */ /* Checkboxes */ /* | Dialysis Catheter placed in outside facility */
      227357, /* | Dialysis Catheter Dressing Occlusive */
      225725, /* | Dialysis Catheter Tip Cultured */ /* Numeric values */
      226499, /* | Hemodialysis Output */
      224154, /* | Dialysate Rate */
      ...
      224406, /* | VEN Lumen Volume */
      226457, /* | Ultrafiltrate Output */
      225959, /* | Medication Added Amount  #1 (Peritoneal Dialysis) */ /* Text values */
      224135, /* | Dialysis Access Site */ /* | Dialysis Site Appearance */
      224139,
      ...
      225952, /* | Medication Added #1 (Peritoneal Dialysis) */ /* | Solution (Peritoneal Dialysis) */
      225953,
      225954, /* | Dialysis Access Type */ /* | Reason for CRRT Filter Change */
      225956, /* | Heparin Concentration (units/mL) */
      225958,
      225961, /* | Medication Added Units #1 (Peritoneal Dialysis) */ /* | Peritoneal Dialysis Catheter Type */
      225963, /* | Peritoneal Dialysis Catheter Status */
      225965,
      225976, /* | Replacement Fluid */
...
), mv_ranges /* TODO: */ /*   charttime + dialysis_present + dialysis_active */ /*  for inputevents_cv, outputevents */ /*  for procedures_mv, left join and set the dialysis_type */ /* , oe AS ( */ /*     SELECT stay_id */ /*         , charttime */ /*         , 1 AS dialysis_present */ /*         , 0 AS dialysis_active */ /*         , NULL AS dialysis_type */ /*     FROM `physionet-data.mimiciv_icu.outputevents` */ /*     WHERE itemid IN */ /*         ( */ /*             40386 -- hemodialysis */ /*         ) */ /*         AND value > 0 -- also ensures it's not null */ /* ) */ AS (
  SELECT
    stay_id,
    starttime,
    endtime,
  ...
  WHERE
    itemid IN (
      227536, /*	KCl (CRRT)	Medications	inputevents_mv	Solution */ /*	Calcium Gluconate (CRRT)	Medications	inputevents_mv	Solution */
      227525
    )
...
), stg0 /* union together the charttime tables; */ /* append times from mv_ranges to guarantee they exist */ AS (
  SELECT
    stay_id,
    charttime,
    dialysis_present,
